...
namespace Nop.Plugin.Widgets.JCarousel.Infrastructure
{
    ...
    /// </summary>
    public class ThemeableViewEngine : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                viewLocations = new[] {
                         $"~/Plugins/{JCarouselDefaults.SystemName}/Themes/{theme}/Views/Shared/{context.ViewName}.cshtml",
                         $"~/Plugins/{JCarouselDefaults.SystemName}/Themes/{theme}/Views/{{1}}/{{0}}.cshtml",
                         $"~/Plugins/{JCarouselDefaults.SystemName}/Views/{{1}}/{{0}}.cshtml",
                         $"~/Plugins/{JCarouselDefaults.SystemName}/Views/Shared/{context.ViewName}.cshtml",
                }
                .Concat(viewLocations); //Set our view path at 0 position so first priority take
            }
